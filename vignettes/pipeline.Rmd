...
The `size_threshold = 0` option tells the underlying prediction function keep all the plant-like pixels.
We can set these paramter to a higher number which can be useful if some noise is being confused with a
plant.
